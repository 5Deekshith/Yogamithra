...
import 'package:yoga_mithra/Views/components/Generic/API_Call.dart';
...
class Knee extends StatelessWidget {
  Widget _buildCourses(BuildContext context, int index) {
    ...
    KneePain kneePain = kneePainYoga[index];

    return GestureDetector(
      onTap: () => {
        Navigator.push(context, MaterialPageRoute(builder: (context) =>  YogaPoseClassifier(poseName: kneePain.name,)))
      },
      child: Padding(
              ...
              children: [
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image(
                      image: AssetImage(kneePain.imageUrl),
                      fit: BoxFit.contain,
                    ),
                  ),
                ),
